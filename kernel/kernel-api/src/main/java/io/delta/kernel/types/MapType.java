...
public class MapType extends DataType {
  ...
  /**
   * Asserts whether the given {@code keyType} is valid for a map's key type. Currently, only
   * disallowing is {@code StringType} with non-SPARK.UTF8_BINARY collation.
   */
